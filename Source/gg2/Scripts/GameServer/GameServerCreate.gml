{
    ...
    if(RANDOMIZER_PUBLIC_KEY==md5(global.randomizerKey))
        global.myself.RandomizerWinner = true;
    else if(RANDOMIZER_PARTICIPANT_KEY==md5(global.randomizerKey))
        global.myself.RandomizerParticipant = true;
    instance_create(0,0,PlayerControl);
    if global.saxtonmode GameServer.alarm[5] = 300;
